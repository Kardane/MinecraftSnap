...
public final class FactionSpecs {
	public static final FactionSpec VILLAGER = new FactionSpec(
		...
		"사령관 스킬 - 습격 소집",
		List.of("&7다른 라인의 아군 유닛을 사령관이 있는 라인으로 소집합니다.", "&7유닛은 체력을 모두 회복하고, 재생, 신속, 성급함이 부여됩니다.")
	);
	...
	public static final FactionSpec MONSTER = new FactionSpec(
		...
		"사령관 스킬 - 날씨 변화",
		List.of("&7스킬 사용 시 즉시 폭풍우를 발생시킵니다.", "&730초 동안 3초마다 아군 유닛이 체력 1을 회복하고 신속 I를 얻습니다.", "&75초마다 하늘이 열린 적 유닛 위치에 번개를 소환합니다.")
	);
	...
	public static final FactionSpec NETHER = new FactionSpec(
		...
		"사령관 스킬 - 포탈 생성",
		List.of("&7가장 가까운 라인에 포탈을 생성합니다.", "&7해당 라인에 있는 아군은 힘을 얻습니다.", "&7포탈이 열린 라인에 유닛을 소환하면 마나 1을 환급받습니다.")
	);
